...
<head>
 ...
 <body>
            ...
            echo"<div class='container'>
			    <div class='row' style='border: 1px solid #d1cdcd; border-radius: 12px; padding: 15px; margin-bottom:30px; box-shadow:0px 0px 20px 0px #888888;'>
  			        <div class='col-sm-9'><h2><strong>Order #".$ord['id']."</strong></h2></br>".$ord['id']."  ".$ord["status"]."</br>
			            ...
			            <p style='text-decoration: underline; font-size: 16px;'><strong>Address: </strong></br>".$ord["shipping"]["address_1"]." &nbsp;".$ord["shipping"]["address_2"]."</br>". $ord["shipping"]["city"].",".$ord["shipping"]["state"].",".$ord["shipping"]["country"]."</p>
            ...
            echo"
 			            ...
 			            <div class='col-sm-3'><h4 style='text-decoration: underline; font-size: 16px;'><strong>Customer detail</strong></h4></br>". $ord["billing"]["first_name"].$ord["billing"]["last_name"]."
